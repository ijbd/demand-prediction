...
HYPERPARAMETER_SEARCH_NAME=$BAL_AUTH
...
python hyperparameter_search.py $PROCESSED_DATA_FILE_PATH $HYPERPARAMETER_SEARCH_DIR $HYPERPARAMETER_SEARCH_NAME $MODEL_FILE_PATH
python evaluate.py $PROCESSED_DATA_FILE_PATH $HYPERPARAMETER_SEARCH_DIR $HYPERPARAMETER_SEARCH_NAME $RESULTS_FILE_PATH
